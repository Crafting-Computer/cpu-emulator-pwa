			...
			_Utils_update(
				model,
				{
					computer: _Utils_update(
						...
						{
							ram: A3(
								$author$project$Main$storeToMemory,
								index,
								A2(
									$elm$core$Maybe$withDefault,
									0,
										...
										return A3(
											...
											function (rom) {
												return $elm$json$Json$Decode$succeed(
													{a: a, d: d, m: m, pc: pc, ram: ram, rom: rom});
											});
									});
							});
					});
...
var $author$project$Main$encodeComputer = function (computer) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'a',
				$elm$json$Json$Encode$int(computer.a)),
				_Utils_Tuple2(
				'd',
				$elm$json$Json$Encode$int(computer.d)),
				_Utils_Tuple2(
				'm',
				$elm$json$Json$Encode$int(computer.m)),
				_Utils_Tuple2(
				'pc',
				$elm$json$Json$Encode$int(computer.pc)),
				_Utils_Tuple2(
				'ram',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, computer.ram)),
				_Utils_Tuple2(
				'rom',
				A2($elm$json$Json$Encode$array, $elm$json$Json$Encode$int, computer.rom))
			]));
};
var $author$project$Main$stepComputerPort = _Platform_outgoingPort(
	'stepComputerPort',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$Main$step = F2(
	function (cycles, computer) {
		return $author$project$Main$stepComputerPort(
			_Utils_Tuple2(
				cycles,
				$author$project$Main$encodeComputer(computer)));
	});
var $author$project$Main$stepComputer = function (model) {
	...
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($author$project$Main$step, 1, model.computer),
...
var $author$project$Main$stepComputerOneFrame = F2(
	function (time, model) {
		var timeToRun = A2($elm$core$Basics$min, time, 1000);
		var cycles = $elm$core$Basics$ceiling((((timeToRun / 1000) * 20) * 256) * 1024);
		return _Utils_Tuple2(
			model,
			A2($author$project$Main$step, cycles, model.computer));
	});
