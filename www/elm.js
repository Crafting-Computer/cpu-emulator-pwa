...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$Bottom = {$: 'Bottom'};
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$Model = function (a) {
	return {$: 'Model', a: a};
};
...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$init = function (loadMoreFunc) {
	return $FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(
		{
			direction: $FabienHenon$elm_infinite_scroll$InfiniteScroll$Bottom,
			isLoading: false,
			lastRequest: $elm$time$Time$millisToPosix(0),
			loadMoreFunc: loadMoreFunc,
			offset: 50,
			timeout: 5 * 1000
		});
};
var $author$project$Main$LoadedMoreRam = {$: 'LoadedMoreRam'};
var $author$project$Main$msgToCmd = function (x) {
	return A2(
		$elm$core$Task$perform,
		$elm$core$Basics$identity,
		$elm$core$Task$succeed(x));
};
var $author$project$Main$loadMoreRam = function (_v0) {
	return $author$project$Main$msgToCmd($author$project$Main$LoadedMoreRam);
};
var $author$project$Main$LoadedMoreRom = {$: 'LoadedMoreRom'};
var $author$project$Main$loadMoreRom = function (_v0) {
	return $author$project$Main$msgToCmd($author$project$Main$LoadedMoreRom);
};
	...
	return _Utils_Tuple2(
		{
			...
			isRunningComputer: false,
			program: '',
			ramDisplaySize: 50,
			ramScroll: $FabienHenon$elm_infinite_scroll$InfiniteScroll$init($author$project$Main$loadMoreRam),
			romDisplaySize: 50,
			romScroll: $FabienHenon$elm_infinite_scroll$InfiniteScroll$init($author$project$Main$loadMoreRom)
		},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$EditProgram = function (a) {
	return {$: 'EditProgram', a: a};
};
var $author$project$Main$ReceivedComputer = function (a) {
	return {$: 'ReceivedComputer', a: a};
};
var $author$project$Main$StepComputerOneFrame = function (a) {
	return {$: 'StepComputerOneFrame', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$editProgramPort = _Platform_incomingPort('editProgramPort', $elm$json$Json$Decode$string);
...
var $author$project$Main$receiveComputerPort = _Platform_incomingPort('receiveComputerPort', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$editProgramPort($author$project$Main$EditProgram),
				model.isRunningComputer ? $elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Main$StepComputerOneFrame) : $elm$core$Platform$Sub$none,
				$author$project$Main$receiveComputerPort($author$project$Main$ReceivedComputer)
			]));
};
var $author$project$Main$RamScrollMsg = function (a) {
	return {$: 'RamScrollMsg', a: a};
};
var $author$project$Main$RomScrollMsg = function (a) {
	return {$: 'RomScrollMsg', a: a};
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Main$clearAssemblerErrorPort = _Platform_outgoingPort(
...
var $author$project$AsmParser$CInstruction = function (a) {
	return {$: 'CInstruction', a: a};
};
var $author$project$AsmParser$ExpectingEOF = {$: 'ExpectingEOF'};
var $author$project$AsmParser$UndefinedSymbol = function (a) {
...
var $author$project$AsmParser$ExpectingInstruction = {$: 'ExpectingInstruction'};
var $elm$parser$Parser$Advanced$Loop = function (a) {
	return {$: 'Loop', a: a};
};
var $author$project$AsmParser$AContext = {$: 'AContext'};
var $author$project$AsmParser$ExpectingAtSign = {$: 'ExpectingAtSign'};
var $author$project$AsmParser$ExpectingInt = {$: 'ExpectingInt'};
var $author$project$AsmParser$InvalidNumber = {$: 'InvalidNumber'};
var $author$project$AsmParser$NumberTooLarge = function (a) {
	return {$: 'NumberTooLarge', a: a};
};
var $author$project$AsmParser$ParserAInstruction = function (a) {
	return {$: 'ParserAInstruction', a: a};
};
var $author$project$AsmParser$ParserAInstructionLabel = function (a) {
	return {$: 'ParserAInstructionLabel', a: a};
};
var $author$project$AsmParser$ParserAInstructionNumber = function (a) {
	return {$: 'ParserAInstructionNumber', a: a};
};
...
var $author$project$AsmParser$ExpectingLabel = {$: 'ExpectingLabel'};
var $author$project$AsmParser$Located = F3(
	function (from, value, to) {
...
var $author$project$AsmParser$located = function (parser) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$parser$Parser$Advanced$keeper,
				$elm$parser$Parser$Advanced$succeed($author$project$AsmParser$Located),
...
var $author$project$AsmParser$usedLabel = $author$project$AsmParser$located(
...
var $author$project$AsmParser$aInstruction = A2(
	$elm$parser$Parser$Advanced$andThen,
	function (arg) {
		if (arg.$ === 'ParserAInstructionNumber') {
			var number = arg.a;
			return (_Utils_cmp(
				number,
				A2($elm$core$Basics$pow, 2, 31)) > -1) ? $elm$parser$Parser$Advanced$problem(
				$author$project$AsmParser$NumberTooLarge(number)) : $elm$parser$Parser$Advanced$succeed(
				$author$project$AsmParser$ParserAInstruction(
					$author$project$AsmParser$ParserAInstructionNumber(number)));
		} else {
			var name = arg.a;
			return $elm$parser$Parser$Advanced$succeed(
				$author$project$AsmParser$ParserAInstruction(
					$author$project$AsmParser$ParserAInstructionLabel(name)));
		}
	},
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
			...
			$elm$parser$Parser$Advanced$symbol(
				A2($elm$parser$Parser$Advanced$Token, '@', $author$project$AsmParser$ExpectingAtSign))),
		A2(
			$elm$parser$Parser$Advanced$inContext,
			$author$project$AsmParser$AContext,
			$elm$parser$Parser$Advanced$oneOf(
				_List_fromArray(
					[
						...
						A2($elm$parser$Parser$Advanced$int, $author$project$AsmParser$ExpectingInt, $author$project$AsmParser$InvalidNumber))
					])))));
var $author$project$AsmParser$CContext = {$: 'CContext'};
var $author$project$AsmParser$ExpectingEqualSign = {$: 'ExpectingEqualSign'};
var $author$project$AsmParser$ExpectingSemicolonSign = {$: 'ExpectingSemicolonSign'};
var $author$project$AsmParser$ParserCInstruction = function (a) {
	return {$: 'ParserCInstruction', a: a};
};
var $author$project$AsmParser$ExpectingComputation = {$: 'ExpectingComputation'};
...
var $author$project$AsmParser$computation = function () {
	...
	return A2(
		$elm$parser$Parser$Advanced$andThen,
		function (str) {
			return A2($elm$core$List$member, str, comps) ? $elm$parser$Parser$Advanced$succeed(str) : $elm$parser$Parser$Advanced$problem($author$project$AsmParser$ExpectingComputation);
		},
...
var $author$project$AsmParser$ExpectingDestinations = function (a) {
	return {$: 'ExpectingDestinations', a: a};
};
...
var $author$project$AsmParser$destinations = $elm$parser$Parser$Advanced$oneOf(
	A2(
		$elm$core$List$map,
		function (str) {
			var dest = {
				a: A2($elm$core$String$contains, 'A', str),
				d: A2($elm$core$String$contains, 'D', str),
				m: A2($elm$core$String$contains, 'M', str)
			};
			return A2(
				$elm$parser$Parser$Advanced$map,
				function (_v0) {
				...
				$elm$parser$Parser$Advanced$keyword(
					A2(
						...
						str,
						$author$project$AsmParser$ExpectingDestinations(str))));
		},
		_List_fromArray(
			['AMD', 'AD', 'AM', 'MD', 'M', 'D', 'A'])));
var $author$project$AsmParser$ExpectingJump = function (a) {
	return {$: 'ExpectingJump', a: a};
};
var $author$project$AsmParser$jump = $elm$parser$Parser$Advanced$oneOf(
	A2(
		$elm$core$List$map,
		function (str) {
			var jmp = function () {
				switch (str) {
					case 'JGT':
						return {eq: false, gt: true, lt: false};
					case 'JEQ':
						return {eq: true, gt: false, lt: false};
					case 'JGE':
						return {eq: true, gt: true, lt: false};
					case 'JLT':
						return {eq: false, gt: false, lt: true};
					case 'JNE':
						return {eq: false, gt: true, lt: true};
					case 'JLE':
						return {eq: true, gt: false, lt: true};
					default:
						return {eq: true, gt: true, lt: true};
				}
			}();
			return A2(
				$elm$parser$Parser$Advanced$map,
				...
				$elm$parser$Parser$Advanced$keyword(
					A2(
						$elm$parser$Parser$Advanced$Token,
						str,
						$author$project$AsmParser$ExpectingJump(str))));
		},
		_List_fromArray(
...
var $author$project$AsmParser$optional = F2(
	function (_default, parser) {
		return $elm$parser$Parser$Advanced$oneOf(
			_List_fromArray(
				[
					$elm$parser$Parser$Advanced$backtrackable(parser),
					$elm$parser$Parser$Advanced$succeed(_default)
				]));
	});
var $author$project$AsmParser$cInstruction = A2(
	$elm$parser$Parser$Advanced$inContext,
	$author$project$AsmParser$CContext,
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
			$elm$parser$Parser$Advanced$keeper,
			A2(
				...
				$elm$parser$Parser$Advanced$succeed(
					F3(
						function (dest, comp, jmp) {
							return $author$project$AsmParser$ParserCInstruction(
								{computation: comp, destinations: dest, jump: jmp});
						})),
				A2(
					$author$project$AsmParser$optional,
					...
					A2(
						...
						A2(
							$elm$parser$Parser$Advanced$ignorer,
							$author$project$AsmParser$destinations,
							$elm$parser$Parser$Advanced$symbol(
								A2($elm$parser$Parser$Advanced$Token, '=', $author$project$AsmParser$ExpectingEqualSign)))))),
			$author$project$AsmParser$computation),
		A2(
			$author$project$AsmParser$optional,
			{eq: false, gt: false, lt: false},
			A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity),
					$elm$parser$Parser$Advanced$symbol(
						A2($elm$parser$Parser$Advanced$Token, ';', $author$project$AsmParser$ExpectingSemicolonSign))),
				$author$project$AsmParser$jump))));
...
var $author$project$AsmParser$ParserLabelInstruction = F2(
	function (a, b) {
		return {$: 'ParserLabelInstruction', a: a, b: b};
	});
var $author$project$AsmParser$ExpectingCustomLabel = {$: 'ExpectingCustomLabel'};
...
var $author$project$AsmParser$predefinedSymbolTable = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('R0', 0),
			_Utils_Tuple2('R1', 1),
			...
			_Utils_Tuple2('R8', 8),
			_Utils_Tuple2('R9', 9),
			_Utils_Tuple2('R10', 10),
			_Utils_Tuple2('R11', 11),
			_Utils_Tuple2('R12', 12),
			_Utils_Tuple2('R13', 13),
			_Utils_Tuple2('R14', 14),
			_Utils_Tuple2('R15', 15),
			_Utils_Tuple2(
			'SCREEN',
			A2($elm$core$Basics$pow, 2, 16)),
			_Utils_Tuple2(
			'KBD',
			A2($elm$core$Basics$pow, 2, 16) + A2($elm$core$Basics$pow, 2, 15)),
			_Utils_Tuple2('SP', 0),
			_Utils_Tuple2('LCL', 1),
			_Utils_Tuple2('ARG', 2)
		]));
var $author$project$AsmParser$predefinedLabels = $elm$core$Set$fromList(
	$elm$core$Dict$keys($author$project$AsmParser$predefinedSymbolTable));
var $author$project$AsmParser$declaredLabel = $author$project$AsmParser$located(
	$elm$parser$Parser$Advanced$variable(
		{
			...
			reserved: $author$project$AsmParser$predefinedLabels,
			start: $elm$core$Char$isAlpha
		}));
var $author$project$AsmParser$labelInstruction = function (instructionIndex) {
	return A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
			$elm$parser$Parser$Advanced$ignorer,
			$elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity),
			$elm$parser$Parser$Advanced$symbol(
				A2($elm$parser$Parser$Advanced$Token, '(', $author$project$AsmParser$ExpectingLeftParenSign))),
		A2(
			$elm$parser$Parser$Advanced$inContext,
			$author$project$AsmParser$LabelContext,
			A2(
				$elm$parser$Parser$Advanced$keeper,
				$elm$parser$Parser$Advanced$succeed(
					function (name) {
						return A2($author$project$AsmParser$ParserLabelInstruction, name, instructionIndex);
					}),
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$author$project$AsmParser$declaredLabel,
					$elm$parser$Parser$Advanced$symbol(
						A2($elm$parser$Parser$Advanced$Token, ')', $author$project$AsmParser$ExpectingRightParenSign))))));
};
...
var $author$project$AsmParser$ifProgress = F2(
	function (parser, offset) {
		return A2(
			$elm$parser$Parser$Advanced$map,
			function (newOffset) {
				return _Utils_eq(offset, newOffset) ? $elm$parser$Parser$Advanced$Done(_Utils_Tuple0) : $elm$parser$Parser$Advanced$Loop(newOffset);
			},
			A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
...
var $author$project$AsmParser$sps = A2(
	$elm$parser$Parser$Advanced$loop,
	0,
	$author$project$AsmParser$ifProgress(
		$elm$parser$Parser$Advanced$oneOf(
			_List_fromArray(
				[
					A2(
		...
		function (_v0) {
			...
			var declaredSymbols = A2(
				...
				$elm$core$Set$fromList(
					$elm$core$Dict$keys(declaredSymbolTable)));
			var undefinedSymbols = A3(
				$elm$core$List$foldl,
				F2(
				...
				_List_Nil,
				ast);
			if (!undefinedSymbols.b) {
				var substitutedAst = $elm$core$List$reverse(
					A3(
						$elm$core$List$foldl,
						F2(
							function (instruction, nextAst) {
								switch (instruction.$) {
									case 'ParserAInstruction':
										var arg = instruction.a;
										if (arg.$ === 'ParserAInstructionLabel') {
									...
									case 'ParserCInstruction':
										var record = instruction.a;
										return A2(
											$elm$core$List$cons,
											$author$project$AsmParser$CInstruction(record),
											nextAst);
									default:
										return nextAst;
								}
						...
						_List_Nil,
						ast));
				return $elm$core$Result$Ok(substitutedAst);
			} else {
				return $elm$core$Result$Err(
					A2(
						$elm$core$List$map,
						function (symbol) {
							return {
								col: symbol.from.b,
								contextStack: _List_Nil,
								problem: $author$project$AsmParser$UndefinedSymbol(symbol.value),
								row: symbol.from.a
							};
						},
						undefinedSymbols));
...
var $author$project$AsmParser$showProblem = function (p) {
	switch (p.$) {
		case 'ExpectingAtSign':
			return 'a \'@\'';
		case 'ExpectingEqualSign':
			return 'a \'=\'';
		case 'ExpectingSemicolonSign':
			return 'a \';\'';
		case 'ExpectingLeftParenSign':
			return 'a \'(\'';
		case 'ExpectingRightParenSign':
			return 'a \')\'';
		case 'ExpectingEOF':
			return 'the end of program';
		case 'ExpectingInstruction':
			return 'an instruction';
		case 'ExpectingInt':
			return 'an integer';
		case 'ExpectingDestinations':
			var str = p.a;
			return str;
		case 'ExpectingComputation':
			return 'a computation like \'D+A\' and \'-1\'';
		case 'ExpectingJump':
			var str = p.a;
			return str;
		...
		case 'NumberTooLarge':
			return 'an integer less than 2147483648 (2^31).';
		default:
			return 'a defined symbol';
	}
};
var $author$project$AsmParser$showProblemContext = function (context) {
	switch (context.$) {
		case 'AContext':
...
var $author$project$AsmParser$showProblemContextStack = function (contexts) {
	return A2(
		$elm$core$String$join,
		' of the ',
		A2(
...
var $author$project$AsmParser$getLine = F2(
	function (row, src) {
		return A2(
...
var $author$project$AsmParser$toUnderlineChar = F3(
	function (minCol, maxCol, col) {
		return ((_Utils_cmp(minCol, col) < 1) && (_Utils_cmp(col, maxCol) < 0)) ? _Utils_chr('^') : _Utils_chr(' ');
	});
var $author$project$AsmParser$makeUnderline = F3(
	function (row, minCol, maxCol) {
		return $elm$core$String$fromList(
			A2(
				...
				F2(
					function (i, _v0) {
						return A3($author$project$AsmParser$toUnderlineChar, minCol, maxCol, i);
					}),
				$elm$core$String$toList(row)));
	});
var $elm$core$String$trimLeft = _String_trimLeft;
var $author$project$AsmParser$showProblemLocation = F4(
	function (customLineNumber, row, col, src) {
		var rawLine = A2($author$project$AsmParser$getLine, row, src);
		var lineNumber = function () {
			if (customLineNumber.$ === 'Nothing') {
				return row;
			} else {
				var number = customLineNumber.a;
				return number;
			}
		}();
		var line = $elm$core$String$fromInt(lineNumber) + ('| ' + $elm$core$String$trimLeft(rawLine));
		var offset = ($elm$core$String$length(line) - $elm$core$String$length(rawLine)) - 1;
		var offsettedCol = offset + col;
		var underline = A3($author$project$AsmParser$makeUnderline, line, offsettedCol, offsettedCol + 1);
		return line + ('\n' + underline);
	});
var $author$project$AsmParser$showDeadEndsHelper = F3(
	function (lineNumber, src, _v0) {
		var first = _v0.a;
		var rests = _v0.b;
		var location = A4($author$project$AsmParser$showProblemLocation, lineNumber, first.row, first.col, src);
		var context = $author$project$AsmParser$showProblemContextStack(first.contextStack);
		return location + ('\n' + (function () {
			var _v1 = first.problem;
			switch (_v1.$) {
				case 'InvalidNumber':
					return 'I found an invalid number. I\'m expecting a decimal integer';
				case 'NumberTooLarge':
					var number = _v1.a;
					return 'I found a number `' + ($elm$core$String$fromInt(number) + '` that\'s too large. All numbers should be less than 2147483648 (2^31)');
				case 'UndefinedSymbol':
					var symbol = _v1.a;
					return 'I found an undefined symbol `' + (symbol + ('`. You should declare it as a label somewhere like so: `(' + (symbol + ')`')));
				default:
					var problemStrs = A2(
						$elm$core$List$map,
						A2(
							...
							$author$project$AsmParser$showProblem),
						$elm$core$List$reverse(
							A2($elm$core$List$cons, first, rests)));
					return 'I\'m expecting ' + A2($elm$core$String$join, ' or ', problemStrs);
			}
		}() + (($elm$core$String$isEmpty(context) ? '' : (' in the ' + context)) + '.')));
	});
var $author$project$AsmParser$showDeadEnds = F3(
	function (lineNumber, src, deadEnds) {
...
var $author$project$Main$showAssemblerErrorPort = _Platform_outgoingPort(
...
var $author$project$Main$editProgram = F2(
	function (newProgram, model) {
		var _v0 = $author$project$Assembler$parseProgram(newProgram);
		if (_v0.$ === 'Ok') {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{program: newProgram}),
				$author$project$Main$clearAssemblerErrorPort(_Utils_Tuple0));
		} else {
			var error = _v0.a;
			return _Utils_Tuple2(
				_Utils_update(
				...
				$author$project$Main$showAssemblerErrorPort(error));
		}
	});
var $author$project$Main$editRamPort = _Platform_outgoingPort(
	'editRamPort',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$Main$storeToMemory = F3(
	function (address, value, memory) {
		return A3($elm$core$Array$set, address, value, memory);
	});
var $author$project$Main$editRam = F3(
	function (index, newValueStr, model) {
		var oldComputer = model.computer;
		var newValue = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(newValueStr));
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					computer: _Utils_update(
						oldComputer,
						{
							ram: A3($author$project$Main$storeToMemory, index, newValue, oldComputer.ram)
						})
				}),
			$author$project$Main$editRamPort(
				_Utils_Tuple2(index, newValue)));
	});
...
var $author$project$Main$decodeComputer = A3(
								...
								return A3(
									...
									function (ram) {
										return $elm$json$Json$Decode$succeed(
											{a: a, d: d, m: m, pc: pc, ram: ram, rom: $elm$core$Array$empty});
									});
							});
					});
			});
...
var $author$project$Main$receivedComputer = F2(
	function (json, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
						...
						A2(
							...
							function (computer) {
								return _Utils_update(
									computer,
									{rom: model.computer.rom});
							},
							A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeComputer, json)))
				}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$resetComputerPort = _Platform_outgoingPort(
	'resetComputerPort',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$scrollIntoViewPort = _Platform_outgoingPort('scrollIntoViewPort', $elm$json$Json$Encode$string);
var $author$project$Main$resetComputer = function (model) {
	var oldComputer = model.computer;
	return _Utils_Tuple2(
		_Utils_update(
			model,
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$scrollIntoViewPort('instruction0'),
					$author$project$Main$resetComputerPort(_Utils_Tuple0)
				])));
};
var $author$project$Main$showProgramEditorPort = _Platform_outgoingPort(
	'showProgramEditorPort',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$startEditingProgram = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{isEditingProgram: true}),
		$author$project$Main$showProgramEditorPort(_Utils_Tuple0));
};
...
var $author$project$Main$startEditingRam = F2(
...
var $author$project$Main$startRunningComputer = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{isAnimated: false, isRunningComputer: true}),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$stepComputerPort = _Platform_outgoingPort('stepComputerPort', $elm$json$Json$Encode$int);
var $author$project$Main$step = function (cycles) {
	return $author$project$Main$stepComputerPort(cycles);
};
var $author$project$Main$stepComputer = function (model) {
	var instructionId = 'instruction' + $elm$core$String$fromInt(model.computer.pc);
	return _Utils_Tuple2(
		model,
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					model.isAnimated ? $author$project$Main$scrollIntoViewPort(instructionId) : $elm$core$Platform$Cmd$none
				])));
};
...
var $author$project$Main$stepComputerOneFrame = F2(
	function (time, model) {
		var timeToRun = A2(
			$elm$core$Basics$min,
			A2($elm$core$Basics$max, 150, time),
			1000);
		var cycles = $elm$core$Basics$ceiling(((timeToRun / 1000) * 3000) * 1024);
		return _Utils_Tuple2(
			model,
			$author$project$Main$step(cycles));
	});
...
var $author$project$Main$editRomPort = _Platform_outgoingPort(
	'editRomPort',
...
var $author$project$Assembler$emitProgram = function (instructions) {
	var strToInt = A2(
		$elm$core$Basics$composeL,
		$elm$core$Maybe$withDefault(0),
		$elm$core$String$toInt);
	var convertTo2sComplement = function (number) {
		return (_Utils_cmp(
			number,
			A2($elm$core$Basics$pow, 2, 31)) > -1) ? (number - A2($elm$core$Basics$pow, 2, 32)) : number;
	};
	return A2(
		$elm$core$List$map,
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeL,
					A2($elm$core$Basics$composeL, convertTo2sComplement, $icidasset$elm_binary$Binary$toDecimal),
					$icidasset$elm_binary$Binary$fromIntegers),
				$elm$core$List$map(strToInt)),
			$elm$core$String$split('')),
		A2(
			$elm$core$String$split,
			'\n',
			$author$project$AsmEmitter$emit(instructions)));
};
...
var $author$project$Main$hideProgramEditorPort = _Platform_outgoingPort(
...
var $author$project$Main$stopEditingProgram = function (model) {
	var _v0 = $author$project$Assembler$parseProgram(model.program);
	if (_v0.$ === 'Ok') {
		var instructions = _v0.a;
		var updatedPartOfRom = $elm$core$Array$fromList(
			$author$project$Assembler$emitProgram(instructions));
		var updatedPartOfInstructions = $elm$core$Array$fromList(
			A2($elm$core$List$map, $author$project$Assembler$instructionToString, instructions));
		var restOfOldInstructions = A3(
			$elm$core$Array$slice,
			$elm$core$Array$length(updatedPartOfInstructions),
			$elm$core$Array$length(model.instructions),
			model.instructions);
		var oldComputer = model.computer;
		var restOfOldRom = A3(
			$elm$core$Array$slice,
			$elm$core$Array$length(updatedPartOfRom),
			$elm$core$Array$length(oldComputer.rom),
			oldComputer.rom);
		var nextRom = A2($elm$core$Array$append, updatedPartOfRom, restOfOldRom);
		var nextInstructions = A2($elm$core$Array$append, updatedPartOfInstructions, restOfOldInstructions);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$hideProgramEditorPort(_Utils_Tuple0),
						$author$project$Main$editRomPort(updatedPartOfRom)
					])));
	} else {
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Main$stopEditingRam = F2(
	function (index, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
...
var $author$project$Main$stopRunningComputer = function (model) {
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{isAnimated: true, isRunningComputer: false}),
		$elm$core$Platform$Cmd$none);
};
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$Timeout = F2(
	function (a, b) {
		return {$: 'Timeout', a: a, b: b};
	});
...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$shouldLoadMore = F2(
	function (model, _v0) {
		var scrollTop = _v0.scrollTop;
		var contentHeight = _v0.contentHeight;
		var containerHeight = _v0.containerHeight;
		if (model.isLoading) {
			return false;
		} else {
			var _v1 = model.direction;
			if (_v1.$ === 'Top') {
				return _Utils_cmp(scrollTop, model.offset) < 1;
			} else {
				var excessHeight = contentHeight - containerHeight;
				return _Utils_cmp(scrollTop, excessHeight - model.offset) > -1;
			}
		}
	});
...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$scrollUpdate = F3(
	function (mapper, pos, _v0) {
		...
		return A2($FabienHenon$elm_infinite_scroll$InfiniteScroll$shouldLoadMore, model, pos) ? _Utils_Tuple2(
			$FabienHenon$elm_infinite_scroll$InfiniteScroll$startLoading(
				$FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(model)),
			A2(
	...
	function (mapper, msg, _v0) {
		...
		switch (msg.$) {
			case 'Scroll':
				var pos = msg.a;
				return A3(
					$FabienHenon$elm_infinite_scroll$InfiniteScroll$scrollUpdate,
					mapper,
					pos,
					$FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(model));
			case 'CurrTime':
				var time = msg.a;
				return _Utils_Tuple2(
					$FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(
						_Utils_update(
							model,
							{lastRequest: time})),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								A2(
									...
									$elm$core$Process$sleep(model.timeout)))
							])));
			default:
				var time = msg.a;
				return _Utils_eq(time, model.lastRequest) ? _Utils_Tuple2(
					$FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading(
						$FabienHenon$elm_infinite_scroll$InfiniteScroll$Model(model)),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StepComputer':
				return $author$project$Main$stepComputer(model);
			case 'ReceivedComputer':
				var json = msg.a;
				return A2($author$project$Main$receivedComputer, json, model);
			case 'StepComputerOneFrame':
				var time = msg.a;
				return A2($author$project$Main$stepComputerOneFrame, time, model);
			case 'StartRunningComputer':
				return $author$project$Main$startRunningComputer(model);
			case 'StopRunningComputer':
				return $author$project$Main$stopRunningComputer(model);
			case 'ResetComputer':
				return $author$project$Main$resetComputer(model);
			case 'StartEditingProgram':
				return $author$project$Main$startEditingProgram(model);
			case 'EditProgram':
				var newProgram = msg.a;
				return A2($author$project$Main$editProgram, newProgram, model);
			case 'StopEditingProgram':
				return $author$project$Main$stopEditingProgram(model);
			case 'StartEditingRam':
				var index = msg.a;
				return A2($author$project$Main$startEditingRam, index, model);
			case 'EditRam':
				var index = msg.a;
				var newValue = msg.b;
				return A3($author$project$Main$editRam, index, newValue, model);
			case 'StopEditingRam':
				var index = msg.a;
				return A2($author$project$Main$stopEditingRam, index, model);
			case 'RamScrollMsg':
				var scrollMsg = msg.a;
				var _v1 = A3($FabienHenon$elm_infinite_scroll$InfiniteScroll$update, $author$project$Main$RamScrollMsg, scrollMsg, model.ramScroll);
				var nextRamScroll = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					cmd);
			case 'LoadedMoreRam':
				var nextRamScroll = $FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading(model.ramScroll);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{ramDisplaySize: model.ramDisplaySize + 200, ramScroll: nextRamScroll}),
					$elm$core$Platform$Cmd$none);
			case 'RomScrollMsg':
				var scrollMsg = msg.a;
				var _v2 = A3($FabienHenon$elm_infinite_scroll$InfiniteScroll$update, $author$project$Main$RomScrollMsg, scrollMsg, model.romScroll);
				var nextRomScroll = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{romScroll: nextRomScroll}),
					cmd);
			case 'LoadedMoreRom':
				var nextRomScroll = $FabienHenon$elm_infinite_scroll$InfiniteScroll$stopLoading(model.romScroll);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{romDisplaySize: model.romDisplaySize + 200, romScroll: nextRomScroll}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$StopEditingProgram = {$: 'StopEditingProgram'};
...
var $author$project$Main$colors = {
	darkGrey: A3($mdgriffith$elm_ui$Element$rgb255, 200, 200, 200),
	lightGreen: A3($mdgriffith$elm_ui$Element$rgb255, 102, 255, 102),
...
var $author$project$Main$styles = {
	button: _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colors.lightGrey),
			$mdgriffith$elm_ui$Element$mouseOver(
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colors.darkGrey)
				])),
...
var $author$project$Main$viewCloseEditorButton = function (isEditingProgram) {
	return isEditingProgram ? A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_Utils_ap(
			$author$project$Main$styles.button,
			_List_fromArray(
				[
		...
		{
			label: $mdgriffith$elm_ui$Element$text('Save and Close'),
			onPress: $elm$core$Maybe$Just($author$project$Main$StopEditingProgram)
		}) : $mdgriffith$elm_ui$Element$none;
};
var $author$project$Main$StartEditingProgram = {$: 'StartEditingProgram'};
...
var $author$project$Main$viewEditButton = function (computer) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$Main$styles.button,
		{
			...
			onPress: $elm$core$Maybe$Just($author$project$Main$StartEditingProgram)
		});
};
var $author$project$Main$EditRam = F2(
	function (a, b) {
		return {$: 'EditRam', a: a, b: b};
	});
var $author$project$Main$StartEditingRam = function (a) {
	return {$: 'StartEditingRam', a: a};
};
var $author$project$Main$StopEditingRam = function (a) {
...
var $author$project$Main$indexedTable = F2(
	function (attributes, _v0) {
		var data = _v0.data;
							...
							A2(
								...
								function (column) {
									return A2(
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$width(column.width)
											]),
										A2(column.view, index, cell));
								},
								columns));
					}),
				data));
...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$clientHeight = A2(
...
var $FabienHenon$elm_infinite_scroll$InfiniteScroll$offsetHeight = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['target', 'offsetHeight']),
	$elm$json$Json$Decode$int);
...
var $author$project$Main$viewRam = function (model) {
	var memoryData = $elm$core$Array$toList(
		A3($elm$core$Array$slice, 0, model.ramDisplaySize, model.computer.ram));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
				$author$project$Main$indexedTable,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$FabienHenon$elm_infinite_scroll$InfiniteScroll$infiniteScroll($author$project$Main$RamScrollMsg)),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'height', '640px')),
						$mdgriffith$elm_ui$Element$htmlAttribute(
							...
							view: F2(
								function (index, cell) {
									...
									var cellStyle = (!index) ? _Utils_ap(
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colors.lightGreen)
											])) : commonStyle;
									return A2(
										$mdgriffith$elm_ui$Element$el,
										cellStyle,
										isEditing ? A2(
											...
											_Utils_ap(
												...
												_List_fromArray(
													[
														...
														$author$project$Main$StopEditingRam(index)),
														$mdgriffith$elm_ui$Element$htmlAttribute(
													...
													])),
											{
												...
												onChange: $author$project$Main$EditRam(index),
											...
											_List_fromArray(
												[
													...
													$author$project$Main$StartEditingRam(index)),
													$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
												]),
											$mdgriffith$elm_ui$Element$text(
												model.isAnimated ? $elm$core$String$fromInt(cell) : '-')));
								}),
...
var $author$project$Main$viewRegister = F3(
	function (name, value, isAnimated) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text(
				name + (' = ' + (isAnimated ? $elm$core$String$fromInt(value) : '-'))));
	});
var $author$project$Main$ResetComputer = {$: 'ResetComputer'};
...
var $author$project$Main$viewResetButton = A2(
	...
	$author$project$Main$styles.button,
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Main$ResetComputer)
	});
var $author$project$Main$viewRom = function (model) {
	var instructionData = $elm$core$Array$toList(
		A3($elm$core$Array$slice, 0, model.romDisplaySize, model.instructions));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('ROM'),
				A2(
				$author$project$Main$indexedTable,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$FabienHenon$elm_infinite_scroll$InfiniteScroll$infiniteScroll($author$project$Main$RomScrollMsg)),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'height', '640px')),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'overflow-y', 'auto'))
						...
						[
							...
							view: F2(
								function (index, cell) {
									...
									var cellStyle = (model.isAnimated && _Utils_eq(index, model.computer.pc)) ? _Utils_ap(
										commonStyle,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$Background$color($author$project$Main$colors.lightGreen)
...
var $author$project$Main$StartRunningComputer = {$: 'StartRunningComputer'};
var $author$project$Main$StopRunningComputer = {$: 'StopRunningComputer'};
...
var $author$project$Main$viewRunButton = function (isRunningComputer) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		$author$project$Main$styles.button,
		{
			label: $mdgriffith$elm_ui$Element$html(
				A2(
					...
					_List_Nil,
					isRunningComputer ? $feathericons$elm_feather$FeatherIcons$pause : $feathericons$elm_feather$FeatherIcons$chevronsRight)),
			onPress: isRunningComputer ? $elm$core$Maybe$Just($author$project$Main$StopRunningComputer) : $elm$core$Maybe$Just($author$project$Main$StartRunningComputer)
		});
};
var $author$project$Main$StepComputer = {$: 'StepComputer'};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$viewRam(model),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A3($author$project$Main$viewRegister, 'A', model.computer.a, model.isAnimated),
									A3($author$project$Main$viewRegister, 'D', model.computer.d, model.isAnimated),
									A3($author$project$Main$viewRegister, 'M', model.computer.m, model.isAnimated)
								]))
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					...
					_List_fromArray(
						[
							$author$project$Main$viewRom(model),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									A3($author$project$Main$viewRegister, 'PC', model.computer.pc, model.isAnimated),
									A2(
									$mdgriffith$elm_ui$Element$row,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$author$project$Main$viewSingleStepButton,
											$author$project$Main$viewRunButton(model.isRunningComputer),
									...
									_List_fromArray(
										[
											$author$project$Main$viewEditButton(model.computer)
										]))
								]))
						])),
					$author$project$Main$viewCloseEditorButton(model.isEditingProgram)
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Main$init, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))(0)}});}(window));